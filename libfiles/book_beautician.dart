...
class BookBeauticianScreen extends StatefulWidget {
  @override
  _BookBeauticianScreenState createState() => _BookBeauticianScreenState();
}

class _BookBeauticianScreenState extends State<BookBeauticianScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Book a Beautician', style: TextStyle(color: Colors.white)),
