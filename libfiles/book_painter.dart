...
class BookPainterScreen extends StatefulWidget {
  @override
  _BookPainterScreenState createState() => _BookPainterScreenState();
}

class _BookPainterScreenState extends State<BookPainterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Book a Painter', style: TextStyle(color: Colors.white)),
          ...
          child: Column(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(labelText: 'Painting Type', border: OutlineInputBorder()),
