...
class BookSweeperScreen extends StatefulWidget {
  @override
  _BookSweeperScreenState createState() => _BookSweeperScreenState();
}

class _BookSweeperScreenState extends State<BookSweeperScreen> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _addressController = TextEditingController();
  String? _selectedTask;

  final List<String> _tasks = ['Daily Sweeping', 'Street Cleaning', 'Yard Cleaning', 'Other'];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Book a Sweeper', style: TextStyle(color: Colors.white)),
